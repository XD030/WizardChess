...
> = {
  wizard: {
    ...
    move: ['沿節點連線移動 1 節點。'],
    ability: [
      '導線是指能跟己方學徒或吟遊詩人連結且中間無其他節點，可任意轉換方向，距離不限。',
      '若導線連接至第一個敵方棋子，即可擊殺該棋子，巫師留在原節點。',
      '可與任意己方學徒無距離換位。',
    ],
  },
  apprentice: {
  ...
  dragon: {
    ...
    ability: ['碰到潛行刺客會擊殺。', '經過的節點留下灼痕。', '灼痕雙方都無法停留，可穿越。'],
  },
  ranger: {
    name: '《遊俠》',
    move: ['沿節點連線移動 1 節點。'],
    ability: [
      '類似象棋的炮：沿棋盤直線找到第一個棋子（簡稱跳板），跳過該棋子，繼續搜索第一個敵方棋子並攻擊，然後移動至該位置。',
      '不能跳過未激活的吟遊詩人，不能將潛行刺客當作跳板。',
    ],
  },
  paladin: {
    name: '《聖騎士》',
    move: ['沿節點連線移動 1 節點。'],
    ability: [
      '在可移動範圍內皆是守護區，在範圍內一旦己方棋子被攻擊，可選擇是否守護。',
      '選擇守護的聖騎士會與該棋子交換位置，然後被擊殺，並在守護的棋子位置留下聖光。',
      '聖光只有友方能停留穿越，敵方無法停留穿越。',
      '無法守護潛行己方刺客。',
    ],
  },
  assassin: {
  ...
  bard: {
    name: '《吟遊詩人》',
    move: [
      '以跳棋方式移動：可跳過任何棋子（敵我皆可）抵達其後方的空位，不可連跳。',
      '也可以單步移動到相鄰節點。',
    ],
    ability: [
      '無法被擊殺：任何攻擊都無效。',
