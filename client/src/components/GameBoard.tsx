...
const BOARD_THEME = {
  // ==== 背景 ====
  bgInner: '#0e1734',        // 稍亮的深藍星空
  bgOuter: '#020617',        // 深藍外圈（非純黑）

  // ==== 三角形填色（提升對比） ====
  triDark: 'rgba(20, 28, 62, 0.95)',   // 稍亮、偏藍灰
  triLight: 'rgba(58, 72, 120, 0.90)', // 明顯的藍色光

  // ==== 邊框（再亮、更明顯） ====
  triBorder: 'rgba(220, 230, 255, 0.55)',  // 亮銀藍

  // ==== 節點與線條（提升亮度與存在感） ====
  linkLine: 'rgba(200, 215, 245, 0.28)',   // 線條變亮、加厚存在感
  nodeNormal: 'rgba(230, 240, 255, 0.45)', // 節點亮度上升
  nodeHover: 'rgba(255, 225, 120, 0.95)',  // hover 金光更亮、更明顯

  // ==== 座標文字（提升可見度） ====
  labelText: 'rgba(235, 245, 255, 0.95)',  // 幾乎白色的銀藍，遠距離也看得清
};
