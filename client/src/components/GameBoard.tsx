...
const BOARD_THEME = {
  // ==== 背景（深藍夜空與木頭更搭） ====
  bgInner: '#0f0b06',        // 深棕黑，比原本更暖
  bgOuter: '#080604',        // 深沉背景

  // ==== 三角形填色（木頭深淺） ====
  triDark: 'rgba(60, 40, 25, 0.95)',   // 深胡桃木（偏巧克力咖啡）
  triLight: 'rgba(145, 110, 70, 0.90)', // 淺橡木咖啡（暖棕）

  // ==== 邊框（霧面奶油白，像木板切線） ====
  triBorder: 'rgba(240, 225, 200, 0.55)',

  // ==== 節點與線條（柔和象牙白） ====
  linkLine: 'rgba(240, 225, 200, 0.28)',   // 柔和木紋系線條
  nodeNormal: 'rgba(255, 245, 230, 0.45)', // 象牙白節點
  nodeHover: 'rgba(255, 215, 130, 0.95)',  // 溫暖金橘 hover

  // ==== 座標文字（象牙白、木頭主題很搭） ====
  labelText: 'rgba(250, 240, 225, 0.95)',
};
