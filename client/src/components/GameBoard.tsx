...
const BOARD_THEME = {
  // ==== 背景 ====
  bgInner: '#0a0f24',        // 深藍星空
  bgOuter: '#00040d',        // 更深的外圈

  // ==== 三角形填色 ====
  triDark: 'rgba(12, 18, 44, 0.95)',   // 神秘深藍
  triLight: 'rgba(32, 41, 78, 0.85)',  // 魔力淡藍

  // ==== 邊框 ====
  triBorder: 'rgba(180, 188, 210, 0.45)', // 柔和銀灰

  // ==== 節點與線條 ====
  linkLine: 'rgba(160, 175, 200, 0.16)', // 銀藍細線
  nodeNormal: 'rgba(200, 220, 255, 0.25)', // 淡藍微光
  nodeHover: 'rgba(255, 240, 180, 0.75)',  // 淡金色 hover 亮點

  // ==== 座標文字 ====
  labelText: 'rgba(210, 220, 255, 0.75)', // 星光銀藍
};
